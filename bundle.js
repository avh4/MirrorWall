...
/***/ function(module, exports, require) {
	...
	var React = require(2);
	var ProjectsView = require(3);
	var AddProjectView = require(4);
	var ProjectService = require(5);
...
/***/ function(module, exports, require) {
	...
	var React = require(2);
	var ProjectCard = require(6);

	module.exports = React.createClass({displayName: 'exports',
	  render: function() {
	    if (!this.props.projects) {
	      return React.DOM.div(null, "No project data provided");
	    }
	    var cards = this.props.projects.map(function(project, i) {
	      return React.DOM.div( {className:"col-xs-4 col-sm-3 col-lg-2", key:i}, 
	        ProjectCard( {project:project})
	      );
	    }, this);
	    return React.DOM.div( {className:"row"}, cards);
	  }
	});
...
/***/ function(module, exports, require) {
	...
	module.exports = React.createClass({displayName: 'exports',
	  ...
	  render: function() {
	    return React.DOM.div( {className:"row"}, React.DOM.input( {value:this.state.name, onChange:this.doNameChange}),React.DOM.button( {onClick:this.doAdd}, "Add"));
	  }
	});
...
/***/ function(module, exports, require) {
	...
	module.exports = React.createClass({displayName: 'exports',
	  ...
	  render: function() {
	    ...
	    return React.DOM.div( {className:"project-card", style:{"background-color": "#f77"}}, 
	      React.DOM.span( {className:"name"}, name),
	      React.DOM.button( {className:"delete", onClick:this.doDelete}, React.DOM.i( {className:"fa fa-times"}))
	    );
	  }
	});
...
/***/ function(module, exports, require) {
	...
	var EventConstants = require(33);

	var invariant = require(34);
...
/***/ function(module, exports, require) {
	...
	var PooledClass = require(35);

	var invariant = require(34);
	var traverseAllChildren = require(36);
...
/***/ function(module, exports, require) {
	...
	var ReactPropTypeLocations = require(44);
	var ReactPropTypeLocationNames = require(45);
	var ReactUpdates = require(38);

	var instantiateReactComponent = require(46);
	var invariant = require(34);
	var keyMirror = require(39);
	var merge = require(40);
	var mixInto = require(47);
	var monitorCodeUse = require(41);
	var objMap = require(48);
	var shouldUpdateReactComponent = require(49);
	var warning = require(32);
...
/***/ function(module, exports, require) {
	...
	var CSSPropertyOperations = require(52);
	var DOMProperty = require(29);
	var DOMPropertyOperations = require(10);
	var ReactBrowserComponentMixin = require(53);
	var ReactComponent = require(13);
	var ReactEventEmitter = require(54);
	var ReactMount = require(21);
	var ReactMultiChild = require(22);
	var ReactPerf = require(23);
...
/***/ function(module, exports, require) {
	...
	var ClientReactRootIndex = require(60);
	var CompositionEventPlugin = require(61);
	var DefaultEventPluginOrder = require(62);
	var EnterLeaveEventPlugin = require(63);
	var MobileSafariClickEventPlugin = require(64);
	var ReactBrowserComponentMixin = require(53);
	var ReactComponentBrowserEnvironment =
	  require(65);
	var ReactEventTopLevelCallback = require(66);
	var ReactDOM = require(17);
	var ReactDOMButton = require(67);
	var ReactDOMForm = require(68);
	var ReactDOMImg = require(69);
	var ReactDOMInput = require(70);
	var ReactDOMOption = require(71);
	var ReactDOMSelect = require(72);
	var ReactDOMTextarea = require(73);
	var ReactInstanceHandles = require(20);
	var ReactMount = require(21);
	var SelectEventPlugin = require(74);
	var ServerReactRootIndex = require(75);
	var SimpleEventPlugin = require(76);
...
/***/ function(module, exports, require) {
	...
	var getReactRootElementInContainer = require(81);
	var instantiateReactComponent = require(46);
	var invariant = require(34);
	var shouldUpdateReactComponent = require(49);
...
/***/ function(module, exports, require) {
	...
	var ReactComponent = require(13);
	var ReactMultiChildUpdateTypes = require(82);

	var flattenChildren = require(83);
	var instantiateReactComponent = require(46);
	var shouldUpdateReactComponent = require(49);
...
/***/ function(module, exports, require) {
	...
	var warning = require(32);
	var createObjectFrom = require(84);
...
/***/ function(module, exports, require) {
	...
	/* WEBPACK VAR INJECTION */(function(require, process) {// vim:ts=4:sts=4:sw=4:
	/*!
	 *
	...
	/* WEBPACK VAR INJECTION */}.call(exports, require, require(126)))
...
/***/ function(module, exports, require) {
	...
	var EventConstants = require(33);
	var EventListener = require(94);
	var EventPluginHub = require(95);
...
/***/ function(module, exports, require) {
	...
	var ReactDOMIDOperations = require(107);
	var ReactMarkupChecksum = require(85);
	var ReactMount = require(21);
	var ReactPerf = require(23);
...
/***/ function(module, exports, require) {
	...
	var getEventTarget = require(109);
	var mixInto = require(47);
...
/***/ function(module, exports, require) {
	...
	var getActiveElement = require(112);
	var isTextInputElement = require(102);
	var keyOf = require(55);
	var shallowEqual = require(113);
...
/***/ function(module, exports, require) {
	...
	var EventPluginUtils = require(11);
	var EventPropagators = require(100);
	var SyntheticClipboardEvent = require(114);
	var SyntheticEvent = require(101);
	var SyntheticFocusEvent = require(115);
	var SyntheticKeyboardEvent = require(116);
	var SyntheticMouseEvent = require(106);
	var SyntheticDragEvent = require(117);
...
/***/ function(module, exports, require) {
	...
	var PooledClass = require(35);
	var ReactMountReady = require(124);
	var ReactPutListenerQueue = require(125);
	var Transaction = require(121);
...
/***/ function(module, exports, require) {
	...
	var accumulate = require(128);
	var forEachAccumulated = require(129);
	var invariant = require(34);
	var isEventSupported = require(99);
	var monitorCodeUse = require(41);
...
/***/ function(module, exports, require) {
	...
	exports.binding = function (name) {
	    if (name === 'evals') return (require)(140)
...
/***/ function(module, exports, require) {
	...
	/* WEBPACK VAR INJECTION */(function(require, process) {var filter = require(143);
...
/***/ function(module, exports, require) {
	...
	var createArrayFrom = require(146);
	var getMarkupWrap = require(142);
	var invariant = require(34);
